...
const MANUAL_COORDS = {
  ...
  "d3-bonjour-tristesse": { lat: 52.4999144, lng: 13.4434645 },
  "d3-hejduk": { lat: 52.5049275, lng: 13.3921753 },
  "d3-zanderroth": { lat: 52.5044415, lng: 13.4166273 },
...
const QUERY_OVERRIDES = {
  ...
  "d3-zanderroth": "Waldemarstraße 17 Berlin Kreuzberg WH_17",
  "d3-bonjour-tristesse": "Bonjour Tristesse Falckensteinstraße Berlin Siza",
