...
export const LABELS_BY_ID = {
  ...
  "d6-altes-museum": ["ausstellung", "vor1900", "neoklassizismus"],
  "d6-neues": ["vor1900", "ausstellung", "neoklassizismus"],
  ...
  "d4-sony": ["nach1990", "zugaenglich", "postmoderne"],
  ...
  "d3-holocaust": ["dekonstruktivismus", "zugaenglich", "nach1990"],
  "d4-band": ["vor1939", "neoklassizismus"],
  "d3-topo": ["ausstellung", "nach1990"],
  "d4-reichstag": ["nach1990", "zugaenglich", "neoklassizismus"],
  "d3-botschaft": ["nach1990", "privat"],
  "d2-hkw": ["moderne", "brd"],
  "d4-siegessaeule": ["zugaenglich", "vor1900", "neoklassizismus"],
  "d2-hansa": ["moderne", "brd"],
  "d4-icc": ["postmoderne", "privat", "brd"],
  "d1-unite": ["moderne", "vor1939"],
  "d1-olympia": ["vor1939", "neoklassizismus"],
  ...
  "d4-newton": ["postmoderne", "ausstellung", "nach1990"],
  ...
  "d2-kma": ["ddr", "neoklassizismus"],
  "d5-berghain": ["ddr", "privat", "neoklassizismus"],
  "d5-oberbaum": ["vor1939"],
  "d5-amazon": ["nach1990"],
  ...
  "d5-ullsteinhaus": ["expressionismus"],
  "d5-tempelhof": ["vor1939", "neoklassizismus"],
  ...
  "d5-paul-lincke": ["zugaenglich", "neoklassizismus"],
...
/** Stil-Labels – Projekte ohne eines davon erhalten zusätzlich „zeitgenössisch“. */
export const ARCH_STYLE_LABELS = ["moderne", "postmoderne", "dekonstruktivismus", "neoklassizismus", "expressionismus"];

export function withZeitgenoessisch(labels) {
  const list = labels || [];
  if (list.includes("zeitgenoessisch")) return list;
  if (list.some((l) => ARCH_STYLE_LABELS.includes(l))) return list;
  return [...list, "zeitgenoessisch"];
}
...
export const LABEL_DEFS = {
  ...
  neoklassizismus: { de: "Neo-Klassizismus", en: "Neo-Classicism", bg: "#0d0d0d", color: "#ffffff" },
  expressionismus: { de: "Expressionismus", en: "Expressionism", bg: "#0d0d0d", color: "#ffffff" },
  zeitgenoessisch: { de: "zeitgenössisch", en: "contemporary", bg: "#0d0d0d", color: "#ffffff" },
  dekonstruktivismus: { de: "Dekonstruktivismus", en: "Deconstructivism", bg: "#0d0d0d", color: "#ffffff" },
  vor1900: { de: "vor 1900", en: "before 1900", bg: "#0d0d0d", color: "#ffffff" },
