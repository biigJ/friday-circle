(function () {
  ...
  var MAP = {
    ...
    "ziele.html": [
      ...
      { s: ".goals-overlay__cta:nth-of-type(1)", html: true, de: '→ Erstes Programm: <span class="goals-overlay__cta-brand">gogogo</span>', en: '→ First program: <span class="goals-overlay__cta-brand">gogogo</span>' },
      { s: ".goals-overlay__cta:nth-of-type(2)", de: "Und: Deinen Space verändern.", en: "And: change your space." },
    ],
    "loesungen.html": [
