(function () {
  ...
  var MAP = {
    ...
    "ziele.html": [
      ...
      { s: ".goals-overlay__cta:nth-of-type(1)", html: true, de: '→ Erstes Programm: <span class="goals-overlay__cta-brand goals-overlay__cta-brand--gogogo">gogogo</span>', en: '→ First program: <span class="goals-overlay__cta-brand goals-overlay__cta-brand--gogogo">gogogo</span>' },
      { s: ".goals-overlay__cta:nth-of-type(2)", html: true, de: '→ Deinen Space verändern: <span class="goals-overlay__cta-brand goals-overlay__cta-brand--biig">biig Interior</span>', en: '→ Change your space: <span class="goals-overlay__cta-brand goals-overlay__cta-brand--biig">biig Interior</span>' },
    ],
    "loesungen.html": [
