(function () {
  ...
  var MAP = {
    ...
    "ziele.html": [
      ...
      { s: ".goals-overlay__copy p:nth-of-type(1)", de: "Wer bewusst lebt, ist zufriedener. Das klingt banal, trifft aber selten den Alltag der meisten Menschen in Berlin. Zwischen Job, Handy und dem Anspruch, ständig erreichbar und produktiv zu sein, bleibt wenig Raum für Entscheidungen, die wirklich von einem selbst kommen. Friday Circle entsteht aus der Überzeugung, dass sich das ändern lässt, ohne das eigene Leben komplett umzukrempeln.", en: "Those who live consciously are more satisfied. That sounds banal, but it rarely matches the everyday life of most people in Berlin. Between work, the phone, and the expectation of being constantly reachable and productive, there is little room for decisions that truly come from yourself. Friday Circle comes from the conviction that this can change without completely overturning your life." },
    ],
    "loesungen.html": [
